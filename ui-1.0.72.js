...
PZ.ui.objectTypes.set(PZ.effect, [
    ...
    { name: "PANZOID+ CUSTOM EFFECTS", category: true },
    { name: "Echo", desc: "Echo effect from CM4", type: "echo" },
    { name: "AE Fractal Noise", desc: "AE Fractal Noise effect", type: "aefractalnoise" },
    { name: "Ambient occlusion", desc: "Ambient occlusion effect", type: "ambientocclusion" },
    { name: "Ascii", desc: "Ascii effect", type: "ascii" },
    { name: "Bokeh Blur", desc: "Bokeh Blur effect", type: "bokehblur" },
    { name: "Cartoon", desc: "Cartoon effect", type: "cartoon" },
    { name: "Chromatic aberration", desc: "Chromatic aberration effect", type: "chromaticaberration" },
    { name: "Color expansion", desc: "Color expansion effect", type: "colorexpansion" },
    { name: "Colorisma", desc: "Colorisma effect", type: "colorisma" },
    { name: "Corner Pin", desc: "Corner Pin effect", type: "cornerpin" },
    { name: "Edge blur", desc: "Edge blur effect", type: "edgeblur" },
    { name: "Extrude", desc: "Extrude effect", type: "extrude" },
    { name: "Ghost", desc: "Ghost effect", type: "ghost" },
    { name: "Glitch", desc: "Glitch effect", type: "glitch" },
    { name: "Halftone", desc: "Halftone effect", type: "halftone" },
    { name: "Inner shadow", desc: "Inner shadow effect", type: "innershadow" },
    { name: "Invert channel", desc: "Invert channel effect", type: "invertchannel" },
    { name: "Leave color", desc: "Leave color effect", type: "leavecolor" },
    { name: "Light sweep", desc: "Light sweep effect", type: "lightsweep" },
    { name: "Liquify", desc: "Liquify effect", type: "liquify" },
    { name: "Liquify Advanced", desc: "Liquify Advanced effect", type: "liquifyadvanced" },
    { name: "Mirror+", desc: "Mirror+ effect", type: "mirror" },
    { name: "Motion blur", desc: "Motion blur effect", type: "motionblur" },
    { name: "Oil Paint", desc: "Oil Paint effect", type: "oilpaint" },
    { name: "PsykoBlobs", desc: "PsykoBlobs effect", type: "psykoblobs" },
    { name: "Radial Step Wipe", desc: "Radial Step Wipe effect", type: "radialstepwipe" },
    { name: "Shine", desc: "Shine effect", type: "shine" },
    { name: "Stroke", desc: "Stroke effect", type: "stroke" },
    { name: "Time Displacement", desc: "Time Displacement effect", type: "timedisplacement" },
    { name: "Tint", desc: "Tint effect", type: "tint" },
    { name: "Toon", desc: "Toon effect", type: "toon" },
    { name: "Turbidity", desc: "Turbidity effect", type: "turbidity" },
    { name: "Turbulent displace", desc: "Turbulent displace effect", type: "turbulentdisplace" },
    { name: "Venetian blinds", desc: "Venetian blinds effect", type: "venetianblinds" },
    { name: "Vignette", desc: "Vignette effect", type: "vignette" },
    { name: "Warp waves", desc: "Warp waves effect", type: "warpwaves" },
    {
        name: "Twitch",
    ...
    {
        name: "Tint",
        desc: "Tints the image with a color.",
        type: 1,
        data: { type: 1, properties: { name: "Tint", fragShader: "precision mediump float; uniform sampler2D tDiffuse; varying vec2 vUv; uniform vec3 rgb; uniform float strength; void main(){ vec4 texel = texture2D(tDiffuse, vUv); vec3 tintedColor = mix(texel.rgb, texel.rgb * rgb, strength); gl_FragColor = vec4(tintedColor, texel.a); }" }, customProperties: [{ type: { custom: true, dynamic: true, type: 0, min: 0, max: 1 }, properties: { name: "strength" }, keyframes: [{ value: 1 }] }, { type: { custom: true, group: true, dynamic: true, objects: [{ dynamic: true, name: "r", type: 0, min: 0, max: 1 }, { dynamic: true, name: "g", type: 0, min: 0, max: 1 }, { dynamic: true, name: "b", type: 0, min: 0, max: 1 }], type: 4 }, properties: { name: "rgb" }, objects: [{ keyframes: [{ value: 1 }] }, { keyframes: [{ value: 1 }] }, { keyframes: [{ value: 1 }] }] }] },
    },
    {
        name: "Color Expansion",
        desc: "Boosts color intensity beyond normal limits.",
        type: 1,
        data: { type: 1, properties: { name: "Color expansion", fragShader: "precision highp float; uniform sampler2D tDiffuse; varying vec2 vUv; uniform float strength; void main(){ vec4 color = texture2D(tDiffuse, vUv); vec3 texel = color.rgb * (1.0 + strength); texel = clamp(texel , 0.0, 1.0); gl_FragColor = vec4(texel, color.a); }" }, customProperties: [{ type: { custom: true, dynamic: true, type: 0, min: 0, max: 2 }, properties: { name: "strength" }, keyframes: [{ value: 0.20 }] }] },
    },
    {
        name: "Chromatic Aberration",
        desc: "Splits color channels outward from center.",
        type: 1,
        data: { type: 1, properties: { name: "Chromatic aberration", fragShader: "precision highp float; uniform sampler2D tDiffuse; varying vec2 vUv; uniform float strength; uniform float red; uniform float green; uniform float blue; void main() { vec2 centered = vUv - vec2(0.5, 0.5); float str = strength * length(centered); vec2 redOffset = vUv + centered * red * 0.025 * str; vec4 redColor = texture2D(tDiffuse, redOffset); vec2 greenOffset = vUv + centered * green * 0.025 * str; vec4 greenColor = texture2D(tDiffuse, greenOffset); vec2 blueOffset = vUv + centered * blue * 0.025 * str; vec4 blueColor = texture2D(tDiffuse, blueOffset); vec4 finalColor; finalColor.r = redColor.r; finalColor.g = greenColor.g; finalColor.b = blueColor.b; finalColor.a = (redColor.a + greenColor.a + blueColor.a) / 3.0; gl_FragColor = finalColor; }" }, customProperties: [{ type: { custom: true, dynamic: true, type: 0, min: 0, max: 3 }, properties: { name: "strength" }, keyframes: [{ value: 1 }] }, { type: { custom: true, dynamic: true, type: 0, min: 0, max: 1 }, properties: { name: "red" }, keyframes: [{ value: -0.50 }] }, { type: { custom: true, dynamic: true, type: 0, min: 0, max: 1 }, properties: { name: "green" }, keyframes: [{ value: 0 }] }, { type: { custom: true, dynamic: true, type: 0, min: 0, max: 1 }, properties: { name: "blue" }, keyframes: [{ value: -0.50 }] }] },
    },
    {
        name: "Invert Channel",
        desc: "Inverts pixels near a specified color.",
        type: 1,
        data: { type: 1, properties: { name: "Invert channel", fragShader: "precision highp float;uniform sampler2D tDiffuse;varying vec2 vUv;uniform float strength;uniform vec3 rgb;void main(){vec4 texel=texture2D(tDiffuse,vUv);float dist=distance(texel.rgb,rgb);vec3 inverted=mix(texel.rgb,1.0-texel.rgb,smoothstep(strength,strength-0.5,dist));gl_FragColor=vec4(inverted,texel.a);}" }, customProperties: [{ type: { custom: true, dynamic: true, type: 0, min: 0, max: 1 }, properties: { name: "strength" }, keyframes: [{ value: 1 }] }, { type: { custom: true, group: true, dynamic: true, objects: [{ dynamic: true, name: "r", type: 0, min: 0, max: 1 }, { dynamic: true, name: "g", type: 0, min: 0, max: 1 }, { dynamic: true, name: "b", type: 0, min: 0, max: 1 }], type: 4 }, properties: { name: "rgb" }, objects: [{ keyframes: [{ value: 1 }] }, { keyframes: [{ value: 1 }] }, { keyframes: [{ value: 1 }] }] }] },
    },
    {
        name: "Leave Color",
        desc: "Desaturates all colors except a chosen hue.",
        type: 1,
        data: { type: 1, properties: { name: "Leave color", fragShader: "precision highp float; uniform sampler2D tDiffuse; varying vec2 vUv; uniform vec3 rgb; void main(){ vec4 texel = texture2D(tDiffuse, vUv); float colorDistance = distance(texel.rgb, rgb); vec3 desaturatedColor = mix(texel.rgb, vec3(dot(texel.rgb, vec3(0.212, 0.715, 0.072))), smoothstep(0.65, 0.5, colorDistance)); gl_FragColor = vec4(desaturatedColor, texel.a); }" }, customProperties: [{ type: { custom: true, group: true, dynamic: true, objects: [{ dynamic: true, name: "r", type: 0, min: 0, max: 1 }, { dynamic: true, name: "g", type: 0, min: 0, max: 1 }, { dynamic: true, name: "b", type: 0, min: 0, max: 1 }], type: 4 }, properties: { name: "rgb" }, objects: [{ keyframes: [{ value: 1 }] }, { keyframes: [{ value: 1 }] }, { keyframes: [{ value: 1 }] }] }] },
    },
    {
        name: "Colorisma",
        desc: "All-in-one color grading suite.",
        type: 1,
        data: { type: 1, properties: { name: "Colorisma", fragShader: "precision highp float;uniform sampler2D tDiffuse;varying vec2 vUvScaled;uniform float strength;uniform vec3 tint;uniform float gamma;uniform float brightness;uniform float contrast;uniform float saturation;uniform float hue;uniform float sharpness;uniform float exposure;uniform float midExposure;uniform float sideExposure;vec3 applyBrightness(vec3 color,float value){return color+value;}vec3 applyTint(vec3 color,vec3 t){return color*t;}vec3 applyContrast(vec3 color,float amount){return(color-0.5)*amount+0.5;}vec3 applySaturation(vec3 color,float amount){float luminance=dot(color,vec3(0.2126,0.7152,0.0722));return mix(vec3(luminance),color,amount);}vec3 applyExposure(vec3 color,float amount){return color+amount*color*color;}vec3 applySharpness(vec3 color,float amount){vec3 blurredColor=texture2D(tDiffuse,vUvScaled+vec2(-0.001,0.0)).rgb;blurredColor+=texture2D(tDiffuse,vUvScaled+vec2(0.0,-0.001)).rgb;blurredColor-=2.0*color;return color+blurredColor*-amount;}vec3 rgb2hsv(vec3 c){vec4 K=vec4(0.0,-1.0/3.0,2.0/3.0,-1.0);vec4 p=mix(vec4(c.bg,K.wz),vec4(c.gb,K.xy),step(c.b,c.g));vec4 q=mix(vec4(p.xyw,c.r),vec4(c.r,p.yzx),step(p.x,c.r));float d=q.x-min(q.w,q.y);float e=1.0e-10;return vec3(abs(q.z+(q.w-q.y)/(6.0*d+e)),d/(q.x+e),q.x);}vec3 hsv2rgb(vec3 c){vec4 K=vec4(1.0,2.0/3.0,1.0/3.0,3.0);vec3 p=abs(fract(c.xxx+K.xyz)*6.0-K.www);return c.z*mix(K.xxx,clamp(p-K.xxx,0.0,1.0),c.y);}vec3 applyHue(vec3 color,float adjustment){vec3 hsv=rgb2hsv(color);hsv.x=mod(hsv.x+adjustment,1.0);return hsv2rgb(hsv);}void main(){vec4 texel=texture2D(tDiffuse,vUvScaled);vec3 filteredColor=texel.rgb;filteredColor=applyBrightness(filteredColor,brightness);filteredColor=applyTint(filteredColor,tint);filteredColor=applyContrast(filteredColor,contrast);filteredColor=applySaturation(filteredColor,saturation);filteredColor=applyExposure(filteredColor,exposure);filteredColor=applyHue(filteredColor,hue/8.0);filteredColor=pow(filteredColor,vec3(1.0/gamma));float exposureValue=mix(midExposure,sideExposure,abs(vUvScaled.x-0.5)*2.0);filteredColor*=exposureValue;filteredColor=applySharpness(filteredColor,sharpness);vec3 finalColor=mix(texel.rgb,filteredColor,strength);gl_FragColor=vec4(finalColor,texel.a);}" }, customProperties: [{ type: { custom: true, dynamic: true, type: 0, min: 0, max: 2 }, properties: { name: "strength" }, keyframes: [{ value: 1 }] }, { type: { custom: true, group: true, dynamic: true, objects: [{ dynamic: true, name: "r", type: 0, min: 0, max: 1 }, { dynamic: true, name: "g", type: 0, min: 0, max: 1 }, { dynamic: true, name: "b", type: 0, min: 0, max: 1 }], type: 4 }, properties: { name: "tint" }, objects: [{ keyframes: [{ value: 1 }] }, { keyframes: [{ value: 1 }] }, { keyframes: [{ value: 1 }] }] }, { type: { custom: true, dynamic: true, type: 0, min: 0, max: 2 }, properties: { name: "gamma" }, keyframes: [{ value: 1 }] }, { type: { custom: true, dynamic: true, type: 0, min: -1, max: 1 }, properties: { name: "brightness" }, keyframes: [{ value: 0 }] }, { type: { custom: true, dynamic: true, type: 0, min: 0, max: 2 }, properties: { name: "contrast" }, keyframes: [{ value: 1 }] }, { type: { custom: true, dynamic: true, type: 0, min: 0, max: 6 }, properties: { name: "saturation" }, keyframes: [{ value: 1 }] }, { type: { custom: true, dynamic: true, type: 0, min: 0, max: 1 }, properties: { name: "sharpness" }, keyframes: [{ value: 0 }] }, { type: { custom: true, dynamic: true, type: 0, min: 0 }, properties: { name: "hue" }, keyframes: [{ value: 0 }] }, { type: { custom: true, dynamic: true, type: 0, min: -3, max: 3 }, properties: { name: "exposure" }, keyframes: [{ value: 0 }] }, { type: { custom: true, dynamic: true, type: 0, min: 1, max: 3 }, properties: { name: "midExposure" }, keyframes: [{ value: 1 }] }, { type: { custom: true, dynamic: true, type: 0, min: 1, max: 3 }, properties: { name: "sideExposure" }, keyframes: [{ value: 1 }] }] },
    },
    { name: "IMAGE+", category: true },
    {
        name: "Vignette",
        desc: "Darkens the edges of the frame.",
        type: 1,
        data: { type: 1, properties: { name: "Vignette", fragShader: "precision highp float; uniform sampler2D tDiffuse; varying vec2 vUv; uniform vec2 center; uniform float smoothness; uniform float size; uniform vec3 rgb; void main(){ vec4 color = texture2D(tDiffuse, vUv); float dist = distance(center, vUv); float maxDistance = length(center) * size; float intensity = smoothstep(maxDistance * (1.0 - smoothness), maxDistance, dist); float invertedIntensity = 1.0 - intensity; vec3 texel = mix(rgb, color.rgb, invertedIntensity); gl_FragColor = vec4(texel, color.a); }" }, customProperties: [{ type: { custom: true, dynamic: true, type: 0, min: 0, max: 5 }, properties: { name: "size" }, keyframes: [{ value: 3.5 }] }, { type: { custom: true, dynamic: true, type: 0, min: 0.01, max: 3 }, properties: { name: "smoothness" }, keyframes: [{ value: 1 }] }, { type: { custom: true, group: true, dynamic: true, objects: [{ dynamic: true, name: "x", type: 0, min: -1, max: 1 }, { dynamic: true, name: "y", type: 0, min: -1, max: 1 }], type: 1, min: -1, max: 1 }, properties: { name: "center" }, objects: [{ keyframes: [{ value: 0.5 }] }, { keyframes: [{ value: 0.5 }] }] }, { type: { custom: true, group: true, dynamic: true, objects: [{ dynamic: true, name: "r", type: 0, min: 0, max: 1 }, { dynamic: true, name: "g", type: 0, min: 0, max: 1 }, { dynamic: true, name: "b", type: 0, min: 0, max: 1 }], type: 4 }, properties: { name: "rgb" }, objects: [{ keyframes: [{ value: 0 }] }, { keyframes: [{ value: 0 }] }, { keyframes: [{ value: 0 }] }] }] },
    },
    {
        name: "Bokeh Blur",
        desc: "Simulates camera lens bokeh blur.",
        type: 1,
        data: { type: 1, properties: { name: "Bokeh Blur", fragShader: "precision highp float; precision highp int; uniform sampler2D tDiffuse; varying vec2 vUvScaled; uniform float strength; void main() { vec2 uv = vUvScaled; float goldenAngle = 2.39996323; vec4 color = vec4(0.0); float total = 0.0; float radius = strength * 0.01; vec2 offset = vec2(0.0); float angle = 0.0; for (int i = 0; i < 2048; i++) { angle += goldenAngle; float r = sqrt(float(i) + 0.5) / sqrt(float(2048)); offset = vec2(cos(angle), sin(angle)) * radius * r; offset.y /= 0.5; vec4 texel = texture2D(tDiffuse, uv + offset); float weight = 3.141592 * length(texel.rgb); color += texel * weight; total += weight; } gl_FragColor = color / total; }" }, customProperties: [{ type: { custom: true, dynamic: true, type: 0, min: 0, max: 32 }, properties: { name: "strength" }, keyframes: [{ value: 1 }] }] },
    },
    {
        name: "Edge Blur",
        desc: "Blurs outward from a center point.",
        type: 1,
        data: { type: 1, properties: { name: "Edge blur", fragShader: "precision mediump float; uniform sampler2D tDiffuse; varying vec2 vUv; uniform vec2 center; uniform float strength; uniform float scale; void main() { vec4 sum = vec4(0.0); float distanceToCenter = distance(vUv, center); float blurIntensity = mix(0.0, strength * 3.0, smoothstep(0.0, scale * 12.0, distanceToCenter)); for (int i = 0; i < 128; i++) { float angle = float(i) * (3.14 * 2.0) / float(128.0); vec2 offset = blurIntensity * vec2(cos(angle), sin(angle)); sum += texture2D(tDiffuse, vUv + offset); } gl_FragColor = sum / float(128); }" }, customProperties: [{ type: { custom: true, group: true, dynamic: true, objects: [{ dynamic: true, name: "x", type: 0, min: -1, max: 1 }, { dynamic: true, name: "y", type: 0, min: -1, max: 1 }], type: 1, min: -1, max: 1 }, properties: { name: "center" }, objects: [{ keyframes: [{ value: 0.5 }] }, { keyframes: [{ value: 0.5 }] }] }, { type: { custom: true, dynamic: true, type: 0, min: 0, max: 4 }, properties: { name: "strength" }, keyframes: [{ value: 1.5 }] }, { type: { custom: true, dynamic: true, type: 0, min: 1, max: 4 }, properties: { name: "scale" }, keyframes: [{ value: 2 }] }] },
    },
    {
        name: "Motion Blur",
        desc: "Blurs in a specified direction to simulate motion.",
        type: 1,
        data: { type: 1, properties: { name: "Motion blur", fragShader: "precision highp float; uniform sampler2D tDiffuse; varying vec2 vUv; uniform float strength; uniform vec2 direction; uniform float thickness; void main() { vec4 texel = vec4(0.0); for (int i = 0; i < 512; ++i) { float offset = float(i - 512 / 2) * strength / float(100); texel += texture2D(tDiffuse, vUv + direction / float(100) * offset); } gl_FragColor = texel / float(512) / thickness; }" }, customProperties: [{ type: { custom: true, dynamic: true, type: 0, min: 0, max: 32 }, properties: { name: "strength" }, keyframes: [{ value: 2 }] }, { type: { custom: true, group: true, dynamic: true, objects: [{ dynamic: true, name: "x", type: 0, min: -1, max: 1 }, { dynamic: true, name: "y", type: 0, min: -1, max: 1 }], type: 1, min: -1, max: 1 }, properties: { name: "direction" }, objects: [{ keyframes: [{ value: 0 }] }, { keyframes: [{ value: 0.5 }] }] }, { type: { custom: true, dynamic: true, type: 0, min: 0, max: 2 }, properties: { name: "thickness" }, keyframes: [{ value: 0.9 }] }] },
    },
    {
        name: "Oil Paint",
        desc: "Creates an oil painting stylization effect.",
        type: 1,
        data: { type: 1, properties: { name: "Oil Paint", fragShader: "precision highp float; precision highp int; uniform sampler2D tDiffuse; varying vec2 vUv; uniform float strength; void main() { vec2 resolution = vec2(gl_FragCoord.xy / vUv.xy); vec4 m[8]; vec3 s[8]; for (int i = 0; i < 8; ++i) { m[i] = vec4(0.0); s[i] = vec3(0.0); } float zeta = 1.0 / strength; float eta = 1.0 / strength; for (int y = -24; y <= 24; ++y) { for (int x = -24; x <= 24; ++x) { vec2 v = vec2(x, y) / strength; vec2 texture = vUv + vec2(x, y) / resolution; texture = clamp(texture, vec2(0.0), vec2(1.0)); vec3 c = texture2D(tDiffuse, texture).xyz; c = clamp(c, 0.0, 1.0); float w[8]; float z, vxx, vyy; vxx = zeta - eta * v.x * v.x; vyy = zeta - eta * v.y * v.y; w[0] = max(0.0, v.y + vxx) * max(0.0, v.y + vxx); w[2] = max(0.0, -v.x + vyy) * max(0.0, -v.x + vyy); w[4] = max(0.0, -v.y + vxx) * max(0.0, -v.y + vxx); w[6] = max(0.0, v.x + vyy) * max(0.0, v.x + vyy); v = sqrt(2.0) / 2.0 * vec2(v.x - v.y, v.x + v.y); vxx = zeta - eta * v.x * v.x; vyy = zeta - eta * v.y * v.y; w[1] = max(0.0, v.y + vxx) * max(0.0, v.y + vxx); w[3] = max(0.0, -v.x + vyy) * max(0.0, -v.x + vyy); w[5] = max(0.0, -v.y + vxx) * max(0.0, -v.y + vxx); w[7] = max(0.0, v.x + vyy) * max(0.0, v.x + vyy); float weights = 0.0; for (int i = 0; i < 8; ++i) weights += w[i]; float g = exp(-3.125 * dot(v, v)) / weights; for (int k = 0; k < 8; ++k) { float wk = w[k] * g; m[k] += vec4(c * wk, wk); s[k] += c * c * wk; }}} vec4 ou = vec4(0.0); for (int k = 0; k < 4; ++k) { m[k].rgb /= m[k].w; s[k] = abs(s[k] / m[k].w - m[k].rgb * m[k].rgb); float sigma2 = s[k].r + s[k].g + s[k].b; float w = 1.0 / (1.0 + pow(2048.0 * sigma2, 0.5 * 14.0)); ou += vec4(m[k].rgb * w, w); } gl_FragColor = clamp(ou / ou.w, 0.0, 1.0); }" }, customProperties: [{ type: { custom: true, dynamic: true, type: 0, min: 0, max: 32 }, properties: { name: "strength" }, keyframes: [{ value: 1 }] }] },
    },
    {
        name: "Light Sweep",
        desc: "Adds an angular light sweep over the image.",
        type: 1,
        data: { type: 1, properties: { name: "Light sweep", fragShader: "precision highp float;uniform sampler2D tDiffuse;varying vec2 vUv;uniform float strength;uniform vec2 position;uniform float width;uniform float feather;uniform float angle;uniform vec3 rgb;void main(){vec4 texel=texture2D(tDiffuse,vUv);float rad=radians(angle);float cosA=cos(rad);float sinA=sin(rad);vec2 rotUV=vec2(dot(vUv-position,vec2(cosA,sinA)),dot(vUv-position,vec2(-sinA,cosA)));float gradient=smoothstep(feather*0.5,-feather*0.5,abs(rotUV.y)-width*0.025);gl_FragColor=texel+vec4(rgb,1.0)*gradient*strength*texel.a;}" }, customProperties: [{ type: { custom: true, dynamic: true, type: 0, min: 0, max: 6 }, properties: { name: "strength" }, keyframes: [{ value: 1 }] }, { type: { custom: true, group: true, dynamic: true, objects: [{ dynamic: true, name: "x", type: 0, min: 0, max: 1 }, { dynamic: true, name: "y", type: 0, min: 0, max: 1 }], type: 1, min: 0, max: 1 }, properties: { name: "position" }, objects: [{ keyframes: [{ value: 0.5 }] }, { keyframes: [{ value: 0.5 }] }] }, { type: { custom: true, dynamic: true, type: 0, min: 0, max: 6 }, properties: { name: "width" }, keyframes: [{ value: 0.5 }] }, { type: { custom: true, dynamic: true, type: 0 }, properties: { name: "angle" }, keyframes: [{ value: 110 }] }, { type: { custom: true, dynamic: true, type: 0, min: 0, max: 1 }, properties: { name: "feather" }, keyframes: [{ value: 0.20 }] }, { type: { custom: true, group: true, dynamic: true, objects: [{ dynamic: true, name: "r", type: 0, min: 0, max: 1 }, { dynamic: true, name: "g", type: 0, min: 0, max: 1 }, { dynamic: true, name: "b", type: 0, min: 0, max: 1 }], type: 4 }, properties: { name: "rgb" }, objects: [{ keyframes: [{ value: 1 }] }, { keyframes: [{ value: 1 }] }, { keyframes: [{ value: 1 }] }] }] },
    },
    {
        name: "Shine",
        desc: "Adds radial light rays from a center point.",
        type: 1,
        data: { type: 1, properties: { name: "Shine", fragShader: "precision highp float; uniform sampler2D tDiffuse; varying vec2 vUv; uniform float strength; uniform vec2 center; uniform float thickness; void main(){ vec4 color = vec4(0.0); for (int i = 0; i < 1080; i++){ float t = float(i) * 1.0 / 1080.0; t = t * t; float step = t * strength; vec2 offset = (center - vUv) * step; color += texture2D(tDiffuse, vUv + offset); } color *= thickness / 1080.0; gl_FragColor = color; }" }, customProperties: [{ type: { custom: true, dynamic: true, type: 0, min: 0, max: 1 }, properties: { name: "strength" }, keyframes: [{ value: 0.40 }] }, { type: { custom: true, group: true, dynamic: true, objects: [{ dynamic: true, name: "x", type: 0, min: -1, max: 1 }, { dynamic: true, name: "y", type: 0, min: -1, max: 1 }], type: 1, min: -1, max: 1 }, properties: { name: "center" }, objects: [{ keyframes: [{ value: 0.50 }] }, { keyframes: [{ value: 0.50 }] }] }, { type: { custom: true, dynamic: true, type: 0, min: 0, max: 2 }, properties: { name: "thickness" }, keyframes: [{ value: 1 }] }] },
    },
    {
        name: "Ghost",
        desc: "Creates a ghosting / afterimage distortion.",
        type: 1,
        data: { type: 1, properties: { name: "Ghost", fragShader: "precision highp float;uniform sampler2D tDiffuse;varying vec2 vUv;uniform float scale;uniform float intensity;uniform vec2 position;uniform vec3 tint;void main(){vec2 offset=vUv-position;float dist=length(offset);vec2 dir=normalize(offset);vec2 extrudeUV=position+dir*dist*(1.0-scale);if(extrudeUV.x<0.0||extrudeUV.x>1.0||extrudeUV.y<0.0||extrudeUV.y>1.0){discard;}vec4 color=texture2D(tDiffuse,vUv);vec4 extrudeColor=texture2D(tDiffuse,extrudeUV);vec4 texel=mix(color,extrudeColor,intensity);texel.rgb+=tint;gl_FragColor=texel;}" }, customProperties: [{ type: { custom: true, dynamic: true, type: 0, min: 0, max: 1 }, properties: { name: "scale" }, keyframes: [{ value: 0.40 }] }, { type: { custom: true, dynamic: true, type: 0, min: 0, max: 1 }, properties: { name: "intensity" }, keyframes: [{ value: 0.20 }] }, { type: { custom: true, group: true, dynamic: true, objects: [{ dynamic: true, name: "x", type: 0, min: -3, max: 3 }, { dynamic: true, name: "y", type: 0, min: -3, max: 3 }], type: 1, min: -3, max: 3 }, properties: { name: "position" }, objects: [{ keyframes: [{ value: 0.50 }] }, { keyframes: [{ value: 0.50 }] }] }] },
    },
    {
        name: "Extrude",
        desc: "Extrudes the image in 3D along an angle.",
        type: 1,
        data: { type: 1, properties: { name: "Extrude", fragShader: "precision highp float; precision highp int; uniform sampler2D tDiffuse; varying vec2 vUvScaled; uniform vec3 rgb; uniform float angle; uniform float back; uniform float front; void main() { vec4 finalColor = vec4(0.0); float extrude = back * 0.1; for (int i = 0; i < 4080; i++) { vec2 offset = vec2(cos(angle / 6.0) * extrude, sin(angle / 6.0) * extrude); vec2 uv = vUvScaled + offset; if (uv.x >= 0.0 && uv.x <= 1.0 && uv.y >= 0.0 && uv.y <= 1.0) { vec4 displacedTexel = texture2D(tDiffuse, uv); finalColor = mix(finalColor, displacedTexel, displacedTexel.a); } extrude = min(extrude + 0.00025, front * 0.1); } finalColor.rgb *= rgb; gl_FragColor = finalColor; }" }, customProperties: [{ type: { custom: true, group: true, dynamic: true, objects: [{ dynamic: true, name: "r", type: 0, min: 0, max: 1 }, { dynamic: true, name: "g", type: 0, min: 0, max: 1 }, { dynamic: true, name: "b", type: 0, min: 0, max: 1 }], type: 4 }, properties: { name: "rgb" }, objects: [{ keyframes: [{ value: 1 }] }, { keyframes: [{ value: 1 }] }, { keyframes: [{ value: 1 }] }] }, { type: { custom: true, dynamic: true, type: 0, min: 0 }, properties: { name: "angle" }, keyframes: [{ value: 14 }] }, { type: { custom: true, dynamic: true, type: 0, min: -8.0, max: 0 }, properties: { name: "back" }, keyframes: [{ value: -0.15 }] }, { type: { custom: true, dynamic: true, type: 0, min: 0, max: 8.0 }, properties: { name: "front" }, keyframes: [{ value: 0.2 }] }] },
    },
    { name: "DEFORM+", category: true },
    {
        name: "Mirror+",
        desc: "Creates a kaleidoscope mirror effect with N segments.",
        type: 1,
        data: { type: 1, properties: { name: "Mirror+", fragShader: "precision highp float; uniform sampler2D tDiffuse; varying vec2 vUv; uniform float segments; const float pi = 3.14159265358979323846264; const float two_pi = 2.0 * pi; void main(){ vec2 p = vUv - 0.5; float angle = atan(p.y, p.x); float radius = length(p); float segmentAngle = two_pi / segments; float adjustedAngle = angle + pi; float newAngle = mod(adjustedAngle, segmentAngle) - 0.5 * segmentAngle; vec2 newP = vec2(cos(newAngle), sin(newAngle)) * radius; vec2 newUV = newP + 0.5; vec4 texel = texture2D(tDiffuse, newUV); gl_FragColor = texel; }" }, customProperties: [{ type: { custom: true, dynamic: true, type: 0, min: 1, max: 16 }, properties: { name: "segments" }, keyframes: [{ value: 3 }] }] },
    },
    {
        name: "Warp Waves",
        desc: "Distorts with animated sine wave warping.",
        type: 1,
        data: { type: 1, properties: { name: "Warp waves", fragShader: "precision highp float; uniform sampler2D tDiffuse; varying vec2 vUv; uniform float strength; uniform float twist; uniform float time; void main(){ vec2 offset = vec2(sin(vUv.y * twist + time), sin(vUv.x * twist + time)); vec2 distortedUV = vUv + offset * strength / 5.0; vec4 texel = texture2D(tDiffuse, distortedUV); gl_FragColor = texel; }" }, customProperties: [{ type: { custom: true, dynamic: true, type: 0, min: 0, max: 1 }, properties: { name: "strength" }, keyframes: [{ value: 0.20 }] }, { type: { custom: true, dynamic: true, type: 0, min: 0.25, max: 3 }, properties: { name: "twist" }, keyframes: [{ value: 1.20 }] }, { type: { custom: true, dynamic: true, type: 0, min: 0 }, properties: { name: "time" }, keyframes: [{ value: 0 }] }] },
    },
    {
        name: "Turbulent Displace",
        desc: "Distorts with animated turbulent noise.",
        type: 1,
        data: { type: 1, properties: { name: "Turbulent displace", fragShader: "precision highp float;uniform sampler2D tDiffuse;varying vec2 vUv;uniform float strength;uniform float time;uniform float scale;void main(){float displacementX=cos(vUv.y*strength+time)*(strength*0.005*scale);float displacementY=sin(vUv.x*strength+time)*(strength*0.005*scale);vec2 displacement=vec2(displacementX,displacementY);vec2 distortedUV=vUv+displacement;vec4 texel=texture2D(tDiffuse,distortedUV);gl_FragColor=texel;}" }, customProperties: [{ type: { custom: true, dynamic: true, type: 0, min: 0, max: 16 }, properties: { name: "strength" }, keyframes: [{ value: 14.00 }] }, { type: { custom: true, dynamic: true, type: 0, min: 0, max: 1.5 }, properties: { name: "scale" }, keyframes: [{ value: 1 }] }, { type: { custom: true, dynamic: true, type: 0, min: 0 }, properties: { name: "time" }, keyframes: [{ value: 0 }] }] },
    },
    {
        name: "Turbidity",
        desc: "Adds directional blur turbulence.",
        type: 1,
        data: { type: 1, properties: { name: "Turbidity", fragShader: "precision highp float;uniform sampler2D tDiffuse;varying vec2 vUvScaled;uniform float strength;uniform float rotation;uniform vec2 direction;void main(){vec4 texel=vec4(0.0);for(float i=-1.0;i<=1.0;i+=1.0){for(float j=-1.0;j<=1.0;j+=1.0){vec2 offset=vec2(i,j)*strength;vec2 rotatedOffset=vec2(offset.x*cos(rotation)-offset.y*sin(rotation),offset.x*sin(rotation)+offset.y*cos(rotation));vec2 scaledOffset=rotatedOffset*direction/10.0;texel+=texture2D(tDiffuse,vUvScaled+scaledOffset);}}gl_FragColor=texel/9.0;}" }, customProperties: [{ type: { custom: true, dynamic: true, type: 0, min: 0, max: 5 }, properties: { name: "strength" }, keyframes: [{ value: 2 }] }, { type: { custom: true, dynamic: true, type: 0, min: 0 }, properties: { name: "rotation" }, keyframes: [{ value: 45 }] }, { type: { custom: true, group: true, dynamic: true, objects: [{ dynamic: true, name: "x", type: 0, min: -1, max: 1 }, { dynamic: true, name: "y", type: 0, min: -1, max: 1 }], type: 1, min: -1, max: 1 }, properties: { name: "direction" }, objects: [{ keyframes: [{ value: 0 }] }, { keyframes: [{ value: 0.50 }] }] }] },
    },
    {
        name: "Venetian Blinds",
        desc: "Slices the image into angled blind strips.",
        type: 1,
        data: { type: 1, properties: { name: "Venetian blinds", fragShader: "precision highp float;uniform sampler2D tDiffuse;varying vec2 vUvScaled;uniform float width;uniform float angle;uniform float margin;void main(){float p_width=width;vec4 texel=texture2D(tDiffuse,vUvScaled);float angle_rad=radians(angle)*180.0;float cosAngle=cos(angle_rad);float sinAngle=sin(angle_rad);vec2 p=vUvScaled-vec2(0.5);vec2 rotatedP=vec2(p.x*cosAngle-p.y*sinAngle,p.x*sinAngle+p.y*cosAngle);float sRotated=rotatedP.x+rotatedP.y;float blinds=mod(sRotated,p_width);float p_margin=margin*p_width/float(2);float alpha=step(p_margin,blinds)*step(blinds,p_width-p_margin);gl_FragColor=texel*alpha;}" }, customProperties: [{ type: { custom: true, dynamic: true, type: 0, min: 0.01, max: 1 }, properties: { name: "width" }, keyframes: [{ value: 0.02 }] }, { type: { custom: true, dynamic: true, type: 0, min: 0, max: 1 }, properties: { name: "angle" }, keyframes: [{ value: 0 }] }, { type: { custom: true, dynamic: true, type: 0, min: 0, max: 1 }, properties: { name: "margin" }, keyframes: [{ value: 0.5 }] }] },
    },
    {
        name: "Stroke",
        desc: "Draws a colored outline around opaque areas.",
        type: 1,
        data: { type: 1, properties: { name: "Stroke", fragShader: "precision highp float;uniform sampler2D tDiffuse;varying vec2 vUvScaled;uniform float width;uniform float hue;uniform vec3 rgb;vec3 rgb2hsv(vec3 c){vec4 K=vec4(0.0,-1.0/3.0,2.0/3.0,-1.0);vec4 p=mix(vec4(c.bg,K.wz),vec4(c.gb,K.xy),step(c.b,c.g));vec4 q=mix(vec4(p.xyw,c.r),vec4(c.r,p.yzx),step(p.x,c.r));float d=q.x-min(q.w,q.y);float e=1.0e-10;return vec3(abs(q.z+(q.w-q.y)/(6.0*d+e)),d/(q.x+e),q.x);}vec3 hsv2rgb(vec3 c){vec4 K=vec4(1.0,2.0/3.0,1.0/3.0,3.0);vec3 p=abs(fract(c.xxx+K.xyz)*6.0-K.www);return c.z*mix(K.xxx,clamp(p-K.xxx,0.0,1.0),c.y);}void main(){vec4 texel=texture2D(tDiffuse,vUvScaled);if(texel.a!=1.0&&width>0.0){float width180=width/180.0;float width90=width/90.0;for(int i=0;i<360;i+=1){float angle=radians(float(i));vec2 offset=vec2(cos(angle)*width180,sin(angle)*width90);vec2 newUV=vUvScaled+offset;if(texture2D(tDiffuse,newUV).a!=0.0){vec3 hsv=rgb2hsv(rgb);hsv.x+=hue;vec3 newColor=hsv2rgb(hsv);gl_FragColor=vec4(newColor,1.0);return;}}}gl_FragColor=texel;}" }, customProperties: [{ type: { custom: true, dynamic: true, type: 0, min: 0, max: 16 }, properties: { name: "width" }, keyframes: [{ value: 0.20 }] }, { type: { custom: true, dynamic: true, type: 0, min: 0 }, properties: { name: "hue" }, keyframes: [{ value: 0 }] }, { type: { custom: true, group: true, dynamic: true, objects: [{ dynamic: true, name: "r", type: 0, min: 0, max: 1 }, { dynamic: true, name: "g", type: 0, min: 0, max: 1 }, { dynamic: true, name: "b", type: 0, min: 0, max: 1 }], type: 4 }, properties: { name: "rgb" }, objects: [{ keyframes: [{ value: 0 }] }, { keyframes: [{ value: 0 }] }, { keyframes: [{ value: 0 }] }] }] },
    },
    { name: "STYLIZE+", category: true },
    {
        name: "Halftone",
        desc: "Renders the image as halftone dots.",
        type: 1,
        data: { type: 1, properties: { name: "Halftone", fragShader: "precision mediump float;uniform sampler2D tDiffuse;varying vec2 vUv;uniform float strength;uniform float scale;uniform vec3 rgb;void main(){float size=scale/0.01;vec2 rounded=vec2(floor(vUv.x*size)/size,floor(vUv.y*size)/size);vec2 center=rounded+vec2(0.5/size);float dist=length(vUv-center);if(dist<strength/(size*1.0))gl_FragColor=texture2D(tDiffuse,rounded)*vec4(rgb,1.0);else gl_FragColor=vec4(0.0);}" }, customProperties: [{ type: { custom: true, dynamic: true, type: 0, min: 0, max: 1 }, properties: { name: "strength" }, keyframes: [{ value: 0.5 }] }, { type: { custom: true, dynamic: true, type: 0, min: 0, max: 1 }, properties: { name: "scale" }, keyframes: [{ value: 1 }] }, { type: { custom: true, group: true, dynamic: true, objects: [{ dynamic: true, name: "r", type: 0, min: 0, max: 1 }, { dynamic: true, name: "g", type: 0, min: 0, max: 1 }, { dynamic: true, name: "b", type: 0, min: 0, max: 1 }], type: 4 }, properties: { name: "rgb" }, objects: [{ keyframes: [{ value: 1 }] }, { keyframes: [{ value: 1 }] }, { keyframes: [{ value: 1 }] }] }] },
    },
    {
        name: "Cartoon",
        desc: "Adds cartoon-style edge outlines.",
        type: 1,
        data: { type: 1, properties: { name: "Cartoon", fragShader: "precision highp float; uniform sampler2D tDiffuse; varying vec2 vUv; uniform float strength; uniform vec3 rgb; void main(){ vec4 texel = texture2D(tDiffuse, vUv); vec4 prevTexel = texture2D(tDiffuse, vUv - vec2(1.0 / 512.0, 0.0)); vec4 nextTexel = texture2D(tDiffuse, vUv + vec2(1.0 / 512.0, 0.0)); float prevDist = distance(texel.rgb, prevTexel.rgb); float nextDist = distance(texel.rgb, nextTexel.rgb); float contour = smoothstep(0.1, 1.0 - strength, max(prevDist, nextDist)); vec3 finalColor = mix(texel.rgb, vec3(rgb), contour); gl_FragColor = vec4(finalColor, 1.0); }" }, customProperties: [{ type: { custom: true, dynamic: true, type: 0, min: 0, max: 1 }, properties: { name: "strength" }, keyframes: [{ value: 0.70 }] }, { type: { custom: true, group: true, dynamic: true, objects: [{ dynamic: true, name: "r", type: 0, min: 0, max: 1 }, { dynamic: true, name: "g", type: 0, min: 0, max: 1 }, { dynamic: true, name: "b", type: 0, min: 0, max: 1 }], type: 4 }, properties: { name: "rgb" }, objects: [{ keyframes: [{ value: 0 }] }, { keyframes: [{ value: 0 }] }, { keyframes: [{ value: 0 }] }] }] },
    },
    {
        name: "Toon",
        desc: "Reduces shading to flat toon-style levels.",
        type: 1,
        data: { type: 1, properties: { name: "Toon", fragShader: "precision highp float;uniform sampler2D tDiffuse;varying vec2 vUv;uniform vec3 strength;uniform vec3 rgb;void main(){vec4 texel=texture2D(tDiffuse,vUv);vec3 color=texel.rgb;float intensity=(color.r+color.g+color.b)/3.0;vec3 tint=mix(vec3(0.0),vec3(0.2),step(strength.x,intensity));float step2=step(strength.y,intensity);tint=mix(tint,vec3(0.6),step2);tint=mix(tint,vec3(1.0),step(strength.z,intensity));color=mix(tint,rgb,0.5);gl_FragColor=vec4(color,texel.a);}" }, customProperties: [{ type: { custom: true, group: true, dynamic: true, objects: [{ dynamic: true, name: "x", type: 0, min: 0, max: 1 }, { dynamic: true, name: "y", type: 0, min: 0, max: 1 }, { dynamic: true, name: "z", type: 0, min: 0, max: 1 }], type: 2, min: 0, max: 1 }, properties: { name: "strength" }, objects: [{ keyframes: [{ value: 0.25 }] }, { keyframes: [{ value: 0.40 }] }, { keyframes: [{ value: 1 }] }] }, { type: { custom: true, group: true, dynamic: true, objects: [{ dynamic: true, name: "r", type: 0, min: 0, max: 1 }, { dynamic: true, name: "g", type: 0, min: 0, max: 1 }, { dynamic: true, name: "b", type: 0, min: 0, max: 1 }], type: 4 }, properties: { name: "rgb" }, objects: [{ keyframes: [{ value: 1 }] }, { keyframes: [{ value: 1 }] }, { keyframes: [{ value: 1 }] }] }] },
    },
    {
        name: "Inner Shadow",
        desc: "Adds a colored inner shadow inside opaque edges.",
        type: 1,
        data: { type: 1, properties: { name: "Inner shadow", fragShader: "precision highp float; uniform sampler2D tDiffuse; varying vec2 vUvScaled; uniform vec2 offset; uniform vec3 rgb; void main(){ vec4 texel = texture2D(tDiffuse, vUvScaled); vec2 offsetUv = vUvScaled + (offset * -0.1); vec4 offsetTexel = texture2D(tDiffuse, offsetUv); gl_FragColor = (texel.a == 1.0 && offsetTexel.a == 0.0) ? vec4(rgb, 1.0) : texel; }" }, customProperties: [{ type: { custom: true, group: true, dynamic: true, objects: [{ dynamic: true, name: "x", type: 0, min: -1, max: 1 }, { dynamic: true, name: "y", type: 0, min: -1, max: 1 }], type: 1, min: -1, max: 1 }, properties: { name: "offset" }, objects: [{ keyframes: [{ value: 0.05 }] }, { keyframes: [{ value: -0.05 }] }] }, { type: { custom: true, group: true, dynamic: true, objects: [{ dynamic: true, name: "r", type: 0, min: 0, max: 1 }, { dynamic: true, name: "g", type: 0, min: 0, max: 1 }, { dynamic: true, name: "b", type: 0, min: 0, max: 1 }], type: 4 }, properties: { name: "rgb" }, objects: [{ keyframes: [{ value: 1 }] }, { keyframes: [{ value: 1 }] }, { keyframes: [{ value: 1 }] }] }] },
    },
    {
        name: "Glitch+",
        desc: "Advanced glitch with scanlines, pixelation and noise.",
        type: 1,
        data: { type: 1, properties: { name: "Glitch", fragShader: "precision highp float;uniform sampler2D tDiffuse;varying vec2 vUv;uniform float strength;uniform float scanline;uniform float pixelation;uniform float noise;uniform float inversion;float random(vec2 st){return fract(sin(dot(st.xy,vec2(1.0,100.0)))*5000.0);}void main(){vec4 color=texture2D(tDiffuse,vUv);float pixelSize=0.005*pixelation;vec2 uvPixelated=floor(vUv/pixelSize)*pixelSize;vec4 pixelColor=texture2D(tDiffuse,uvPixelated);float glitchFactor=sin(vUv.y*100.0)*scanline*0.02;vec2 uvGlitch=vec2(fract(vUv.x+glitchFactor),vUv.y);vec4 glitchColor=texture2D(tDiffuse,uvGlitch);vec4 texel=mix(color,pixelColor,mix(1.0,scanline*12.0,strength));texel.rgb=mix(texel.rgb,glitchColor.rgb,mix(1.0,scanline*0.5,strength));float noiseValue=(random(vUv)-0.5)*noise*2.0;texel.rgb+=mix(vec3(0.0),vec3(noiseValue),strength);texel.rgb=mix(texel.rgb,1.0-texel.rgb,inversion*strength);gl_FragColor=mix(color,texel,strength);}" }, customProperties: [{ type: { custom: true, dynamic: true, type: 0, min: 0, max: 1 }, properties: { name: "strength" }, keyframes: [{ value: 1 }] }, { type: { custom: true, dynamic: true, type: 0, min: -12, max: 12 }, properties: { name: "scanline" }, keyframes: [{ value: 12 }] }, { type: { custom: true, dynamic: true, type: 0, min: 1, max: 16 }, properties: { name: "pixelation" }, keyframes: [{ value: 2 }] }, { type: { custom: true, dynamic: true, type: 0, min: 0, max: 12 }, properties: { name: "noise" }, keyframes: [{ value: 2 }] }, { type: { custom: true, dynamic: true, type: 0, min: 0, max: 1 }, properties: { name: "inversion" }, keyframes: [{ value: 0 }] }] },
    },
    {
        name: "Ambient Occlusion",
        desc: "Darkens areas based on surrounding brightness.",
        type: 1,
        data: { type: 1, properties: { name: "Ambient occlusion", fragShader: "precision highp float; uniform sampler2D tDiffuse; varying vec2 vUv; uniform float strength; uniform float distance; void main() { vec4 texel = texture2D(tDiffuse, vUv); float ao = 0.0; for (float i = 0.0; i < 6.28; i += 0.1) { vec2 offset = vec2(cos(i), sin(i)) * distance * 0.005; ao += texture2D(tDiffuse, vUv + offset).r; } ao = 1.0 - clamp(ao * strength * 0.1 / 64.0, 0.0, 1.0); texel.rgb *= ao; gl_FragColor = texel; }" }, customProperties: [{ type: { custom: true, dynamic: true, type: 0, min: 0, max: 6 }, properties: { name: "strength" }, keyframes: [{ value: 3 }] }, { type: { custom: true, dynamic: true, type: 0, min: 0, max: 6 }, properties: { name: "distance" }, keyframes: [{ value: 2 }] }] },
    },
    {
        name: "ASCII",
        desc: "Renders the image with ASCII characters.",
        type: 1,
        data: { type: 1, properties: { name: "Ascii", fragShader: "precision highp float; uniform sampler2D tDiffuse; varying vec2 vUv; uniform float scale; float character(int n, vec2 p) { p = floor(p * vec2(-4.0, 4.0) + 2.5); if (clamp(p.x, 0.0, 4.0) == p.x) { if (clamp(p.y, 0.0, 4.0) == p.y) { int a = int(floor(p.x) + 5.0 * floor(p.y)); if (mod(float(n / int(pow(2.0, float(a)))), 2.0) == 1.0) return 1.0; } } return 0.0; } void main() { vec2 texelSize = vUv / vec2(float(gl_FragCoord.x), float(gl_FragCoord.y)); vec2 pix = gl_FragCoord.xy; vec3 col = texture2D(tDiffuse, floor(pix / (8.0 * scale)) * (8.0 * scale) * texelSize).rgb; float gray = 0.3 * col.r + 0.59 * col.g + 0.11 * col.b; int n = 4096; if (gray > 0.05) n = 215; if (gray > 0.2) n = 65600; if (gray > 0.4) n = 15255086; if (gray > 0.6) n = 15252014; if (gray > 0.8) n = 11512810; if (gray > 0.95) n = 50331647; vec2 p = mod(pix / (4.0 * scale), 2.0) - vec2(1.0); col = col * character(n, p); gl_FragColor = vec4(col, 1.0); }" }, customProperties: [{ type: { custom: true, dynamic: true, type: 0, min: 1, max: 3 }, properties: { name: "scale" }, keyframes: [{ value: 1 }] }] },
    },
    { name: "MISC", category: true },
    {
        name: "Saber",
        desc: "Creates a glowing saber/neon edge effect with animated color.",
        type: 0,
        data: {
            type: 0,
            properties: {
                name: "Saber",
                enabled: { animated: false, keyframes: [{ value: 1, frame: 0, tween: 0 }] },
            },
            customProperties: [
                {
                    type: { custom: true, group: true, dynamic: true, objects: [{ dynamic: true, name: "R", type: 0, value: 1, min: 0, max: 1 }, { dynamic: true, name: "G", type: 0, value: 1, min: 0, max: 1 }, { dynamic: true, name: "B", type: 0, value: 1, min: 0, max: 1 }], type: 4 },
                    properties: { name: "Not made by GreenArts" },
                    objects: [{ animated: false, keyframes: [{ value: 0, frame: 0, tween: 1 }] }, { animated: false, keyframes: [{ value: 1, frame: 0, tween: 1 }] }, { animated: false, keyframes: [{ value: 0, frame: 0, tween: 1 }] }],
                },
                {
                    type: { custom: true, group: true, dynamic: true, objects: [{ dynamic: true, name: "R", type: 0, value: 1, min: 0, max: 1 }, { dynamic: true, name: "G", type: 0, value: 1, min: 0, max: 1 }, { dynamic: true, name: "B", type: 0, value: 1, min: 0, max: 1 }], type: 4 },
                    properties: { name: "Made by AGFX" },
                    objects: [{ animated: false, keyframes: [{ value: 0, frame: 0, tween: 1 }] }, { animated: false, keyframes: [{ value: 0.333, frame: 0, tween: 1 }] }, { animated: false, keyframes: [{ value: 1, frame: 0, tween: 1 }] }],
                },
            ],
            objects: [
                { type: "coloroverlay", properties: { name: "Color Overlay", enabled: { animated: false, keyframes: [{ value: 1, frame: 0, tween: 0 }] }, color: { objects: [{ animated: false, keyframes: [{ value: 1, frame: 0, tween: 1 }] }, { animated: false, keyframes: [{ value: 1, frame: 0, tween: 1 }] }, { animated: false, keyframes: [{ value: 1, frame: 0, tween: 1 }] }] }, opacity: { animated: false, keyframes: [{ value: 1, frame: 0, tween: 1 }] }, blending: "BLEND_SRC_OVER" } },
                { type: "edgedetection", properties: { name: "Edge Detection", enabled: { animated: false, keyframes: [{ value: 1, frame: 0, tween: 0 }] }, amount: { animated: false, keyframes: [{ value: 3.1, frame: 0, tween: 1 }] } } },
                { type: "chromakey", properties: { name: "Chroma Key", enabled: { animated: false, keyframes: [{ value: 1, frame: 0, tween: 0 }] }, backgroundColor: { objects: [{ animated: false, keyframes: [{ value: 0, frame: 0, tween: 1 }] }, { animated: false, keyframes: [{ value: 0, frame: 0, tween: 1 }] }, { animated: false, keyframes: [{ value: 0, frame: 0, tween: 1 }] }] }, weights: { objects: [{ animated: false, keyframes: [{ value: 4, frame: 0, tween: 1 }] }, { animated: false, keyframes: [{ value: 1, frame: 0, tween: 1 }] }, { animated: false, keyframes: [{ value: 2, frame: 0, tween: 1 }] }] }, soften: { animated: false, keyframes: [{ value: 0.5, frame: 0, tween: 1 }] }, invert: 0, mask: 0 } },
                { type: "gradientoverlay", properties: { name: "Gradient Overlay", enabled: { animated: false, keyframes: [{ value: 1, frame: 0, tween: 0 }] }, gradient: [{ position: 0, color: "rgba(255, 255, 255, 1)" }, { position: 0.494, color: "rgba(0, 0, 0, 1)" }], gradientType: 2, offset: { objects: [{ animated: false, keyframes: [{ value: 0, frame: 0, tween: 1 }] }, { animated: false, keyframes: [{ value: 0, frame: 0, tween: 1 }] }] }, scale: { objects: [{ animated: false, keyframes: [{ value: 1, frame: 0, tween: 1 }] }, { animated: false, keyframes: [{ value: 1, frame: 0, tween: 1 }] }] }, rotation: { animated: true, keyframes: [{ value: 0, frame: -1, tween: 1 }, { value: -69.81, frame: 300, tween: 1 }] }, opacity: { animated: false, keyframes: [{ value: 1, frame: 0, tween: 1 }] }, blending: "BLEND_SRC_OVER" } },
                { type: "chromakey", properties: { name: "Chroma Key", enabled: { animated: false, keyframes: [{ value: 1, frame: 0, tween: 0 }] }, backgroundColor: { objects: [{ animated: false, keyframes: [{ value: 0, frame: 0, tween: 1 }] }, { animated: false, keyframes: [{ value: 0, frame: 0, tween: 1 }] }, { animated: false, keyframes: [{ value: 0, frame: 0, tween: 1 }] }] }, weights: { objects: [{ animated: false, keyframes: [{ value: 4, frame: 0, tween: 1 }] }, { animated: false, keyframes: [{ value: 1, frame: 0, tween: 1 }] }, { animated: false, keyframes: [{ value: 2, frame: 0, tween: 1 }] }] }, soften: { animated: false, keyframes: [{ value: 0.5, frame: 0, tween: 1 }] }, invert: 0, mask: 0 } },
                { type: "colorgrading", properties: { name: "Color Grading", enabled: { animated: false, keyframes: [{ value: 1, frame: 0, tween: 0 }] }, shadows: { objects: [{ animated: false, keyframes: [{ value: 1, frame: 0, tween: 1 }] }, { animated: false, keyframes: [{ value: 1, frame: 0, tween: 1 }] }, { animated: false, keyframes: [{ value: 1, frame: 0, tween: 1 }] }] }, midtones: { objects: [{ animated: false, keyframes: [{ value: 1, frame: 0, tween: 1 }] }, { animated: false, keyframes: [{ value: 1, frame: 0, tween: 1 }] }, { animated: false, keyframes: [{ value: 1, frame: 0, tween: 1 }] }] }, highlights: { objects: [{ animated: false, keyframes: [{ value: 1, frame: 0, tween: 1 }] }, { animated: false, keyframes: [{ value: 0.474, frame: 0, tween: 1 }] }, { animated: false, keyframes: [{ value: 0.074, frame: 0, tween: 1 }] }] } } },
                { type: "fxaa", properties: { name: "Antialiasing", enabled: { animated: false, keyframes: [{ value: 1, frame: 0, tween: 0 }] } } },
                { type: "bloom", properties: { name: "Bloom", enabled: { animated: false, keyframes: [{ value: 1, frame: 0, tween: 0 }] }, amount: { animated: false, keyframes: [{ value: 1, frame: 0, tween: 1 }] }, inner: { objects: [{ animated: false, keyframes: [{ value: 1, frame: 0, tween: 1 }] }, { animated: false, keyframes: [{ value: 1, frame: 0, tween: 1 }] }, { animated: false, keyframes: [{ value: 1, frame: 0, tween: 1 }] }] }, outer: { objects: [{ animated: false, keyframes: [{ value: 1, frame: 0, tween: 1 }] }, { animated: false, keyframes: [{ value: 0.504, frame: 0, tween: 1 }] }, { animated: false, keyframes: [{ value: 0, frame: 0, tween: 1 }] }] }, strength: { animated: false, keyframes: [{ value: 2.203, frame: 0, tween: 1 }] }, radius: { animated: false, keyframes: [{ value: 1, frame: 0, tween: 1 }] }, threshold: { animated: false, keyframes: [{ value: 0, frame: 0, tween: 1 }] }, soften: { animated: false, keyframes: [{ value: 0.01, frame: 0, tween: 1 }] }, blendThreshold: { animated: false, keyframes: [{ value: 0.344, frame: 0, tween: 1 }] }, blendSoften: { animated: false, keyframes: [{ value: 0.449, frame: 0, tween: 1 }] } } },
                { type: "hueshift", properties: { name: "Color Shift", enabled: { animated: false, keyframes: [{ value: 1, frame: 0, tween: 0 }] }, amount: { animated: false, keyframes: [{ value: 0, frame: 0, tween: 1 }] } } },
            ],
        },
    },
    {
        name: "Radial Step Wipe",
        desc: "Animated radial wipe with stepped color bands.",
        type: 1,
        data: {
            type: 1,
            properties: {
                name: "Radial Step Wipe",
                fragShader: "precision highp float;\nprecision highp int;\n\nuniform sampler2D tDiffuse;\nvarying vec2 vUvScaled;\n\nuniform vec2 resolution;\n\nuniform float start;\nuniform float end;\nuniform float section_offset;\nuniform float section_width;\nuniform float number_of_colors;\n\nuniform vec3 color_1;\nuniform vec3 color_2;\nuniform vec3 color_3;\nuniform vec3 color_4;\n\nvoid main()\n{\n  float sectOff = section_offset * 50.0;\n  float sectW = section_width / 100.0;\n  float s = start * 360.0 + 180.0;\n  float e = end * 360.0 + 180.0;\n  float x = vUvScaled[0] - 0.5;\n  float y = vUvScaled[1] - 0.5;\n  float h = sqrt(x*x + (y * resolution[1] / resolution[0]) * (y * resolution[1] / resolution[0]));\n  float a = 360.0 - degrees(atan(y, x));\n  float band = floor(h / max(sectW, 0.001));\n  float adjS = s - band * sectOff;\n  float adjE = e - band * sectOff;\n  int col = int(mod(band, max(number_of_colors, 1.0)));\n  vec3 color = col == 0 ? color_1 : col == 1 ? color_2 : col == 2 ? color_3 : color_4;\n  gl_FragColor = vec4(color, 1.0);\n  if (!(a > adjS && a <= adjE)) { gl_FragColor = vec4(0.0); }\n}",
            },
            customProperties: [
                { type: { custom: true, dynamic: true, type: 0 }, properties: { name: "start" }, keyframes: [{ value: 0, frame: 0, tween: 1 }] },
                { type: { custom: true, dynamic: true, type: 0 }, properties: { name: "end" }, keyframes: [{ value: 0, frame: 0, tween: 1 }] },
                { type: { custom: true, dynamic: true, type: 0, min: 0, max: 1 }, properties: { name: "section_offset" }, keyframes: [{ value: 0.35 }] },
                { type: { custom: true, dynamic: true, type: 0, min: 1, max: 50 }, properties: { name: "section_width" }, keyframes: [{ value: 8 }] },
                { type: { custom: true, dynamic: true, type: 0, min: 1, max: 4 }, properties: { name: "number_of_colors" }, keyframes: [{ value: 2 }] },
                { type: { custom: true, group: true, dynamic: true, objects: [{ dynamic: true, name: "R", type: 0, min: 0, max: 1 }, { dynamic: true, name: "G", type: 0, min: 0, max: 1 }, { dynamic: true, name: "B", type: 0, min: 0, max: 1 }], type: 4 }, properties: { name: "color_1" }, objects: [{ keyframes: [{ value: 1 }] }, { keyframes: [{ value: 1 }] }, { keyframes: [{ value: 1 }] }] },
                { type: { custom: true, group: true, dynamic: true, objects: [{ dynamic: true, name: "R", type: 0, min: 0, max: 1 }, { dynamic: true, name: "G", type: 0, min: 0, max: 1 }, { dynamic: true, name: "B", type: 0, min: 0, max: 1 }], type: 4 }, properties: { name: "color_2" }, objects: [{ keyframes: [{ value: 1 }] }, { keyframes: [{ value: 1 }] }, { keyframes: [{ value: 1 }] }] },
                { type: { custom: true, group: true, dynamic: true, objects: [{ dynamic: true, name: "R", type: 0, min: 0, max: 1 }, { dynamic: true, name: "G", type: 0, min: 0, max: 1 }, { dynamic: true, name: "B", type: 0, min: 0, max: 1 }], type: 4 }, properties: { name: "color_3" }, objects: [{ keyframes: [{ value: 1 }] }, { keyframes: [{ value: 1 }] }, { keyframes: [{ value: 1 }] }] },
                { type: { custom: true, group: true, dynamic: true, objects: [{ dynamic: true, name: "R", type: 0, min: 0, max: 1 }, { dynamic: true, name: "G", type: 0, min: 0, max: 1 }, { dynamic: true, name: "B", type: 0, min: 0, max: 1 }], type: 4 }, properties: { name: "color_4" }, objects: [{ keyframes: [{ value: 1 }] }, { keyframes: [{ value: 1 }] }, { keyframes: [{ value: 1 }] }] },
            ],
        },
    },
